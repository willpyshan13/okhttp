...
sealed class CallEvent {
  ...
  data class DnsEnd(
    ...
    override fun closes(timestampNs: Long) = DnsStart(
        timestampNs, call, domainName)
  }
  ...
  data class ConnectEnd(
    ...
    override fun closes(timestampNs: Long) =
        ConnectStart(timestampNs, call, inetSocketAddress,
            proxy)
  }
  ...
  data class SecureConnectEnd(
    ...
    override fun closes(timestampNs: Long) = SecureConnectStart(
        timestampNs, call)
  }
  ...
  data class ConnectionReleased(
    ...
    override fun closes(timestampNs: Long) = ConnectionAcquired(
        timestampNs, call, connection)
  }
  ...
  data class CallEnd(
    ...
    override fun closes(timestampNs: Long) = CallStart(
        timestampNs, call)
  }
  ...
  data class RequestHeadersEnd(
    ...
    override fun closes(timestampNs: Long) = RequestHeadersStart(
        timestampNs, call)
  }
  ...
  data class RequestBodyEnd(
    ...
    override fun closes(timestampNs: Long) = RequestBodyStart(
        timestampNs, call)
  }
  ...
  data class ResponseBodyEnd(
    ...
    override fun closes(timestampNs: Long) = ResponseBodyStart(
        timestampNs, call)
  }
